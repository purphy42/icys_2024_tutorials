...
user_vasp_sets = [
('static_opt', 'static', {'NPAR':None,'ISTART':None,'NELM':None,'PREC':None,'ALGO':None,'KGAMMA':None
                         ,'ENCUT':300,'SIGMA':None,'LPLANE':None}),
('static_opt_cell', 'ion_relax_packet', {'ISIF': 3}),

('bulk', 'static_opt', {'NSW':50, 'EDIFFG':-0.05, 'EDIFF':1e-5, 'ISIF':2, 'ENCUT':300, 'ENAUG': 450, 'add_nbands':1.3, 
    'KSPACING': 0.7, 'ISMEAR': 0, 'SIGMA':0.1,'NELM':100, 'NPAR': None, 'LREAL': 'Auto', 'ISTART': 1, 'LMAXMIX': 4, 
     'POTIM': 0.2, 'LASPH': '.TRUE.', 'LORBIT': 11,   'PREC': 'Accurate', "IBRION": 1, "NELMDL": -8, 
      'LPLANE': ".TRUE", 'ALGO': 'Normal', "LWAVE": ".FALSE.", "ISPIN": 0 }, 'over'),

('o2_box', 'bulk', {'magnetic_moments':{'O':1.}, 'ISTART':0, 'KSPACING':10., 'ENCUT':300, 'ENAUG':450, 'POTIM':0.2,
    'KGAMMA':'.FALSE.','add_nbands':2, 'ISMEAR':0, 'LREAL':'.FALSE.', 'SIGMA':0.02, "NSW": 100, "IBRION": 1, "NELMDL": -8,}, "over"),

('bulk_eos', 'bulk', {"ISIF": 4, "IBRION": 1, "NELMDL": -8,}, 'over'),
('surface', 'bulk', {'IDIPOL':3, 'LDIPOL':'.TRUE.', "IBRION": 1, "NELMDL": -8,}, 'over'),
